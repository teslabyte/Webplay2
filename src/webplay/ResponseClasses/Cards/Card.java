...
public class Card {
    ...
    private int awakening_route_id;
    ...
    public int getAwakening_route_id() {
        return awakening_route_id;
    }

    public void setAwakening_route_id(int awakening_route_id) {
        this.awakening_route_id = awakening_route_id;
    }
